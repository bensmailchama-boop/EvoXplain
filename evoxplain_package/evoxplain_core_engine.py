#!/usr/bin/env python3
"""
evoxplain_core_engine.py - EvoXplain Mechanism Discovery Engine
Includes support for: Adult, Breast Cancer (BC), COMPAS, Colored MNIST, MIMIC-CXR, German Credit, ACS Income,
                       ...
                       Synthetic Ground-Truth K2 / K1 (basin-geometry validation),
                       TCGA Tumour vs Normal (via tcga_xena_adapter)
Attributions: SHAP, Integrated Gradients (IG), Gini
"""
