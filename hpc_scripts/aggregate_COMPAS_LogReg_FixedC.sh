#!/bin/bash
#SBATCH --job-name=compas_fixedC_agg
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=2
#SBATCH --mem=16GB
#SBATCH --time=02:00:00
#SBATCH --output=logs/compas_fixedC_agg_%j.log
#SBATCH --error=logs/compas_fixedC_agg_%j.err
...
echo "=== AGGREGATION JOB (COMPAS Fixed C=${FIXED_C_VALUE}) ==="
echo "HOST=$(hostname)"
