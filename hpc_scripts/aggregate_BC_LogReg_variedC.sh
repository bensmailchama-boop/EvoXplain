#!/bin/bash
#SBATCH --job-name=bc_aggregate
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64GB
#SBATCH --time=04:00:00
#SBATCH --output=logs/bc_aggregate_%j.log
#SBATCH --error=logs/bc_aggregate_%j.log
...
# =============================================================================
# CONFIGURATION (must match chunk job settings)
# =============================================================================
N_SPLITS=10
